            ...
            <div id="layoutSidenav_content">-->
                <!--<main>-->
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                        <div class="mb-3">
                            <label for="fp_codigo">Codigo del Forma de Pago</label>
                            <input type="text" name="fp_codigo" type="list" list="fp_codigo">
                            <datalist id="fp_codigo">
                                <?php
                                while($fila = $result->fetch_assoc()):
                                    $fp_codigo = $fila['fp_codigo'];
                                    echo '<option value="'.$fila[fp_codigo].'"></option>';
                                endwhile; 
                                ?>
                            </detalist> 
                        ...
                        <td>
                            <form action="./filtro.php?fp_codigo=<?PHP echo $fp_codigo?>" method="POST">
                                <input type="submit" class="btn btn-primary" name="create" value="Buscar">
                            </form>
                        </td>
